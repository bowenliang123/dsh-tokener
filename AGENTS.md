...
- A [GitHub Actions workflow](.github/workflows/release.yml) then verifies the manifest and publishes the package to npm automatically by github workflow. Agent don't have to do or check it manually.
